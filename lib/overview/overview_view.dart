...
import 'package:ri_medicare/overview/widgets/transaction_card.dart';
...
class OverViewPage extends GetView<OverViewController> {
              ...
              Obx(() {
                ...
                if (myLoansController.error.value != null) {
                  return Padding(
                    ...
                    child: Center(
                        child: Text('Error: ${myLoansController.error.value}')),
                  );
                }
                ...
                return Obx(() =>
                    LoanSummarySection(
                      ...
                      onTileExpand: (idx) =>
                      controller.expandedTileIndex.value = idx,
                    ));
              }),
                ...
                Obx(
                      ...
                      Text(
                        controller.healthCard.value != null
                            ? "Health Card ID: ${controller.healthCard.value!
                            .uhid}"
                            : "No Health Card",
                        style: TextStyle(
                          fontSize: 10,
        ...
        children: [
          Container(
            ...
            padding: EdgeInsets.symmetric(
                vertical: isTablet ? 24 : 16, horizontal: isTablet ? 24 : 16),
            decoration: BoxDecoration(
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    Text(
                      '${controller.healthCard.value!.cardType[0]
                          .toUpperCase()}${controller.healthCard.value!.cardType
                          .substring(1)} Health Card',
                      style: TextStyle(
                        color: Colors.white,
                        fontWeight: FontWeight.bold,
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Text(
                          controller.healthCard.value!.expiryDate.toString()
                              .split(' ')[0],
                          style: TextStyle(
                            color: Colors.white,
                            fontWeight: FontWeight.bold,
  ...
  Widget _buildBalanceSectionOverview(BuildContext context,) {
    ...
    Widget _buildBalanceCardOverview(String title, String amount,
      ...
      return Padding(
        ...
        child: Wrap(
          ...
          children: [
            ...
            _buildActionButtonOverview(
                Icons.chat_bubble_outline, 'Chatbot', context, () {
    ...
    Widget _buildActionButtonOverview(IconData icon, String label,
                    ...
                    child: Hero(
                      ...
                      child: Material(
                        ...
                        child: _buildOverviewCard(
                          ...
                          subtitle: controller
                              .cards[index]['subtitle'] as String,
